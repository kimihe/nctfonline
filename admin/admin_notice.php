...
<div class="container col-md-6 col-md-offset-1" >
	<form class="form-horizontal" role="form" method="post" action="admin_notice.php">
		<div class="form-group">
			<label for="message" class="col-md-2 control-label">添加公告</label>
			<div class="col-sm-10">
...
<?php 
	$sOutput .= '<div  class="container col-md-6 col-md-offset-1"  style="width:480px" ><table class="table"  width="40"><tbody>';
	$query = "select content,times from nctf_notice order by times DESC";
	//Run the query
	$result = $dbc->query($query);
	if($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
		    $sOutput .= '<tr><td><h4>'.$row["content"];
